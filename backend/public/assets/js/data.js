...
export const VENUE_MAPS_URL = 'https://www.google.com/maps/search/?api=1&query=DBRA+SOSE+Kalkaji+New+Delhi';
...
export const PARTNERS = [
  { id: 'google-cloud', name: 'GOOGLE CLOUD', category: 'INFRASTRUCTURE', tier: 'TITANIUM', website: 'https://cloud.google.com', description: 'Providing scalable GPU clusters & Vertex AI credits to all accepted teams.' },
  { id: 'anthropic', name: 'ANTHROPIC', category: 'AI RESEARCH', tier: 'TITANIUM', website: 'https://anthropic.com', description: 'Frontier AI models and API tier access for autonomous agent builders.' },
  { id: 'supabase', name: 'SUPABASE', category: 'DATABASE & AUTH', tier: 'PLATINUM', website: 'https://supabase.com', description: 'Instant Postgres, Auth, and Vector databases for rapid production builds.' },
  { id: 'github', name: 'GITHUB', category: 'DEVELOPER PLATFORM', tier: 'PLATINUM', website: 'https://github.com', description: 'Official code platform, Actions compute, and Copilot licenses.' },
  { id: 'solana', name: 'SOLANA', category: 'DECENTRALIZED', tier: 'GOLD', website: 'https://solana.com', description: 'High throughput Layer 1 infrastructure and $15,000 track grants.' },
  { id: 'vercel', name: 'VERCEL', category: 'DEPLOYMENT', tier: 'GOLD', website: 'https://vercel.com', description: 'Edge runtime deployment networks and zero-configuration hosting.' },
  { id: 'modal', name: 'MODAL', category: 'SERVERLESS AI', tier: 'ECOSYSTEM', website: 'https://modal.com', description: 'Serverless cloud compute for Python, AI pipelines, and custom containers.' },
  { id: 'resend', name: 'RESEND', category: 'COMMUNICATION', tier: 'ECOSYSTEM', website: 'https://resend.com', description: 'Modern developer-first transactional messaging APIs.' }
];
